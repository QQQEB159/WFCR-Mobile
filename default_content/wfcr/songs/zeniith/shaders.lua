...
function onEvent(name, value1, value2)
    ...
    elseif string.lower(name) == "bloomhigh" then
        setShaderProperty("bloom", "effect", 0.4)
    ...
    elseif string.lower(name) == "mirrorscreenmovey" then
        tweenShaderProperty("mirror", "y", tonumber(value1), stepCrochet * 0.001 * tonumber(value2), 'cubeOut')
    ...
    elseif string.lower(name) == "mirrorscreenmoveybump" then
        setShaderProperty("mirror", "y", tonumber(value1))
        tweenShaderProperty("mirror", "y", 0, stepCrochet * 0.001 * tonumber(value2), 'cubeOut')
