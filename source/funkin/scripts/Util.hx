...
class DebugText extends FlxText
{
	...
	public function new(text:String, parentGroup:FlxTypedGroup<DebugText>) {
		...
		setFormat(Paths.font("droidbold.ttf"), 20, 0xFFFFFFFF, LEFT, FlxTextBorderStyle.OUTLINE_FAST, 0xFF000000);
		scrollFactor.set();
		borderSize = 1;
	}
...
class ModchartText extends FlxText
{
	...
	public function new(x:Float, y:Float, text:String, width:Float)
	{
		...
		setFormat(Paths.font("droidbold.ttf"), 16, 0xFFFFFFFF, CENTER, FlxTextBorderStyle.OUTLINE_FAST, 0xFF000000);
