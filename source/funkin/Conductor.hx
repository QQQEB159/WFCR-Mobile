...
class Conductor {
	...
	@:noCompletion static inline function get_crotchet()
		return crochet;

	@:noCompletion static inline function set_crotchet(v:Float)
		return crochet = v;

	@:noCompletion @:isVar public static var stepCrotchet(get, set):Float;

	@:noCompletion static inline function get_stepCrotchet()
		return stepCrochet;

	@:noCompletion static inline function set_stepCrotchet(v:Float)
