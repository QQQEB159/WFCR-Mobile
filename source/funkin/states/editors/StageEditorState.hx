...
class StageEditorState extends MusicBeatState{
	...
	*/
	...
	var dadDropDown:FlxScrollableDropDownMenu;
	var gfDropDown:FlxScrollableDropDownMenu;
	var bfDropDown:FlxScrollableDropDownMenu;
	...
	override function create()
	{
		...
		var weirdArray = FlxScrollableDropDownMenu.makeStrIdLabelArray([''], true);
		dadDropDown = new FlxScrollableDropDownMenu(15, 110, weirdArray, function(character:String)
		{
		...
		gfDropDown = new FlxScrollableDropDownMenu(15, 70, weirdArray, function(character:String)
		{
			var daAnim = characterList[Std.parseInt(character)];
			updateGF(daAnim);
		...
		bfDropDown = new FlxScrollableDropDownMenu(15, 30, weirdArray, function(character:String)
		{
			var daAnim = characterList[Std.parseInt(character)];
			updateBF(daAnim);
		...
		var stageDropDown = new FlxScrollableDropDownMenu(15, 30, FlxScrollableDropDownMenu.makeStrIdLabelArray(stages, true), function(character:String){
		...
		xPosTxt.setFormat(Paths.font("droidbold.ttf"), 20, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE_FAST, FlxColor.BLACK);
		xPosTxt.scrollFactor.set();
		xPosTxt.borderSize = 1.25;
		xPosTxt.cameras = [camMenu];

		yPosTxt.setFormat(Paths.font("droidbold.ttf"), 20, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE_FAST, FlxColor.BLACK);
		yPosTxt.scrollFactor.set();
		yPosTxt.borderSize = 1.25;
		yPosTxt.cameras = [camMenu];

		charTxt.setFormat(Paths.font("droidbold.ttf"), 20, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE_FAST, FlxColor.BLACK);
	...
	function reloadCharacterArray()
	{
		...
		var weirdArray = FlxScrollableDropDownMenu.makeStrIdLabelArray(characterList, true);
