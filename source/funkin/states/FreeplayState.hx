...
class FreeplayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		hintText.setFormat(Paths.font("droidbold.ttf"), 16, 0xFFFFFFFF, RIGHT);
		hintText.scrollFactor.set();
		add(hintText);

		////
		scoreText = new FlxText(FlxG.width * 0.7, 5, 0, 'PERSONAL BEST: 0', 32);
		scoreText.setFormat(Paths.font("droidbold.ttf"), 32, 0xFFFFFFFF, RIGHT);
	...
	function reloadFont(){
		scoreText.font = Paths.font("droidbold.ttf");
