...
class NoteOffsetState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		timeTxt.setFormat(Paths.font("droidbold.ttf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE_FAST, FlxColor.BLACK);
		...
		changeModeText.setFormat(Paths.font("droidbold.ttf"), 32, FlxColor.WHITE, CENTER);
