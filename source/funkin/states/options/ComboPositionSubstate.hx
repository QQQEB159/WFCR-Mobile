...
class ComboPositionSubstate extends MusicBeatSubstate
{
	...
	override public function create()
	{
		...
		timing.setFormat(Paths.font("droidbold.ttf"), 28, 0xFFFFFFFF, CENTER, FlxTextBorderStyle.OUTLINE_FAST, 0xFF000000);
		...
		function makeText(i){
			...
			text.setFormat(Paths.font("droidbold.ttf"), 24, 0xFFFFFFFF, LEFT, FlxTextBorderStyle.OUTLINE_FAST, 0xFF000000);
			text.borderSize = 1.5;
