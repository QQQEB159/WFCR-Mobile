...
class MusicBeatState extends FlxUIState {
	...
	@:noCompletion inline function get_curStep()
		return Conductor.curStep;

	@:noCompletion inline function get_curBeat()
		return Conductor.curBeat;

	@:noCompletion inline function get_curDecStep()
		return Conductor.curDecStep;

	@:noCompletion inline function get_curDecBeat()
		return Conductor.curDecBeat;

	@:noCompletion inline function set_curStep(v)
		return Conductor.curStep = v;

	@:noCompletion inline function set_curBeat(v)
		return Conductor.curBeat = v;

	@:noCompletion inline function set_curDecStep(v)
		return Conductor.curDecStep = v;

	@:noCompletion inline function set_curDecBeat(v)
		return Conductor.curDecBeat = v;
	#end
