...
class KadeHUD extends BaseHUD
{
	...
	public function new(iP1:String, iP2:String, songName:String, stats:Stats)
	{
		...
		watermark.setFormat(Paths.font("droidbold.ttf"), 16, 0xFFFFFFFF, RIGHT, FlxTextBorderStyle.OUTLINE, 0xFF000000);
		...
		scoreTxt.setFormat(Paths.font("droidbold.ttf"), 16, 0xFFFFFFFF, FlxTextAlign.CENTER, FlxTextBorderStyle.OUTLINE, 0xFF000000);
		...
		timeTxt.setFormat(Paths.font("droidbold.ttf"), 16, FlxColor.WHITE, RIGHT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		for(counterIdx => judge in displayedJudges){
			...
			txt.setFormat(Paths.font("droidbold.ttf"), 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE,FlxColor.BLACK);
