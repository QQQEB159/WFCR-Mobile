...
class JudgeCounterSettings {
	...
	public var nameFont:String = 'droidbold.ttf';
	public var numbFont:String = 'droidbold.ttf';
...
class JudgementCounter extends FlxTypedSpriteGroup<FlxText> 
{
	...
	public function new(x:Float, y:Float, judgeName:String, colour:FlxColor, counterSettings:JudgeCounterSettings) {
		...
		text.setBorderStyle(OUTLINE_FAST, 0xFF000000, counterSettings.textBorderSize);
		...
		numb.setBorderStyle(OUTLINE_FAST, 0xFF000000, counterSettings.textBorderSize);
