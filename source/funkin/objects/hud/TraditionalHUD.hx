...
{	
	...
	override public function new(iP1:String, iP2:String, songName:String, stats:Stats)
	{
		...
		#if tgt
		scoreTxt.setFormat(Paths.font("droidbold.ttf"), 20, FlxColor.WHITE, CENTER);
		scoreTxt.setBorderStyle(OUTLINE_FAST, FlxColor.BLACK, 1.25);
		#else
		scoreTxt.setFormat(Paths.font('droidbold.ttf'), 18, FlxColor.WHITE, CENTER);
		scoreTxt.setBorderStyle(OUTLINE_FAST, FlxColor.BLACK, 1.5);
		#end
	...
	var counterOptions:JudgeCounterSettings = {
		...
		textSize: 24,
		textBorderSize: 1.25,
		nameFont: "droidbold.ttf",
		numbFont: "droidbold.ttf"
		#else
		textBorderSpacing: 6,
		textLineSpacing: 22,
		textSize: 20,
