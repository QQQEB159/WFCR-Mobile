...
class FlxScrollableDropDownMenu extends FlxUIDropDownMenu {
	...
	public function new(X:Float = 0, Y:Float = 0, DataList:Array<flixel.addons.ui.StrNameLabel>, ?Callback:String->Void, ?Header:FlxUIDropDownHeader,
			?DropPanel:flixel.addons.ui.FlxUI9SliceSprite, ?ButtonList:Array<FlxUIButton>, ?UIControlCallback:(Bool, FlxUIDropDownMenu) -> Void) {
	 ...
	 * @return	The StrIDLabel array ready to be used in FlxScrollableDropDownMenu's constructor
	 */
